...
# Last Change       - Mon  5 Mar 16:01:56 GMT 2018
...
for FILE in VimPlugins/*.vim; {
	/bin/rm -v $HOME/VimPlugins/datepaste.vim 2> /dev/null
	/bin/ln -v VimPlugins/datepaste.vim $HOME/VimPlugins/datepaste.vim 2> /dev/null
}
